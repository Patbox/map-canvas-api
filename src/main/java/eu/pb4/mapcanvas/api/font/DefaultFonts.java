...
public final class DefaultFonts {
    public static final FontRegistry REGISTRY = new FontRegistry(Identifier.fromNamespaceAndPath("mapcanvasapi", "empty"));
    ...
    static {
        ...
        VANILLA = REGISTRY.register(Identifier.parse("minecraft:default"), read(path.resolve("vanilla.mcaf")));
        ALT = REGISTRY.register(Identifier.parse("minecraft:alt"), read(path.resolve("alt.mcaf")));
        ILLAGER_ALT = REGISTRY.register(Identifier.parse("minecraft:illageralt"), read(path.resolve("illageralt.mcaf")));
        UNSANDED_BASE = REGISTRY.register(Identifier.parse("unsanded:base"), read(path.resolve("unsanded.mcaf")));
        UNSANDED = REGISTRY.register(Identifier.parse("unsanded:full"), FontUtils.merge(UNSANDED_BASE, VANILLA));
        UNIFONT = REGISTRY.register(Identifier.parse("unifont:default"), new MojangUnifontFont(CanvasFont.Metadata.create("Unifont",
        ...
        var jp = CanvasFont.Metadata.create("Unifont JP",
                List.of("Roman Czyborra", "Paul Hardy"),
                "https://scripts.sil.org/OFL");
        UNIFONT_JP = REGISTRY.register(Identifier.parse("unifont:japanese"), new StackedLazyFont(new LazyCanvasFont[]{
                ...
                UNIFONT}, jp));
        REGISTRY.register(Identifier.parse("minecraft:uniform"), UNIFONT);
    }
